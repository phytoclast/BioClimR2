...
Stronger global warming: at year 2070 (scenario = RCP 8.5, model = CCSM4)
                       <br>Temperature and preciptation error bars coorespond to the 10th and 90th percentiles of the geographic variability of the climate averages. NPP was estimated to be between 0.8 to 1.2 kg C per square meter per AET depending on vegetation type or fertility, and multiplied by 2 for dry weight. AET was assumed to track monthly values for dry sites (high slope position, low soil water holding capacity), and annual totals for moist sites (low slope position, high soil water holding capacity).  More information about the 
                      "),
